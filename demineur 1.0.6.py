...
¤ Mises à jours :
    ...
    mises à jour supplémentaires:
        _ Redimension de la grille en 9x9 (au lieu de 10x10).
        _ Indexation des lignes et colonnes de 1 à 9 lors des intéractions avec l'utilisateur (affichage de la grille et demande de coordonnées)
        -> L'indexation reste inchangée (de 0 à 8) lors des traitements en interne.

¤ Démineur version 1.0.6 (Réindexations)
