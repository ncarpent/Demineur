...
_ le nombre de bombes trouvées sur le nombre de bombes total est aussi affiché lors de l'affichage d'une grille de jeu.
_ conditions de fin moins restrictives : il suffit que les cases sans bombes soient ouvertes, il n'y a plus besoin que les autres soient marquées par une "marque bombe" ("!").
_ possibilité de retirer les marques.
_ impossibilité de marquer une case ouverte.
_ impossibilité d'ouvrir une case marquée par une "marque bombe" ("!").
_ la première action est libre : on peut placer / supprimer autant de marque qu'on le souhaite avant l'ouverture de case initiale.
_ lors d'une défaite : affichage de la grille dans laquelle toutes les bombes sont révélées.

¤ Démineur version 1.1.0 (Amélioration des marques)
